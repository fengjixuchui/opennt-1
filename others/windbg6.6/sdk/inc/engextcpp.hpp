...
public:
    ...
    // Warn and Err are convenience routines for
    // the warning and error cases.
    ULONG m_OutMask;
...
public:
    ...
    bool HasNode(void)
    {
        ...
        return m_Node.GetPtr() != 0 && m_Node.GetPtr() != m_Head;
    }
