...
Const VERSION = "6.03.001"
Const VERSIONDATE = "11/8/2005"
'
' !!!   ATTENTION   !!!!!!!!!
'    
' Note for users of previous versions
'
' The new version of ADPLUS doesn't use the old constants you had to change
' to configure ADPlus. All these constants were replaced by new switches and
' a feature that allows you to configure ADPlus with a configuration file.
'
' The new documentation is included in the Debugger's help file debugger.chm.
' Look under:
'
...
'
'
'To get fast access to the new switches documentation look under:
'
'Using Debugging Tools for Windows
'   Reference
...
'*
'*              For more information on how to use ADPlus or how to configure it please read the
'*
'*                  ADPlus.doc
'*
'*              that ships with this tool. You can also refer to the following KB:
...
'*-------------------------------------------------------------------------------
'For more information on using ADPlus, please see:
'
' The debugger's help file (debugger.chm). Look under:
'
'Using Debugging Tools for Windows
'   Crash Dump Files
'      User-Mode Dump Files
...
Sub GetCurrentProcesses()
	...
	While not objTextFile.AtEndofStream
		...
		If instr(strAux, "Command Line:") = 0 then
			...
			' removing the first five chars; they are always "0 32" (it used to be only 2 chars - it didn't have the 32)
			strAux = Right(strAux, StrLength - 5)
