...
//#define VK_DBE_ENTERPENCONVERSIONMODE  0x0fd
...
// ;internal is needed by JAPAN, CWIN user should ignore it
#if defined(TAIWAN)
#ifdef CWIN_SK
...
/* CTRL_SEND is default one, because it is usually used */
...
#if defined(TAIWAN)
LONG WINAPI WINNLSIMEControl(HWND,HWND,LPIMESTRUCT);
