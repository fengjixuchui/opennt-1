...
_TEXT	SEGMENT
; File ..\..\wow.c
@HMValidateHandle@8 PROC NEAR				; COMDAT
; Line 259
	push	esi
...
;	COMDAT @HMValidateHandleNoRip@8
_TEXT	SEGMENT
@HMValidateHandleNoRip@8 PROC NEAR			; COMDAT
; Line 330
	push	esi
	mov	eax, DWORD PTR _wow16gpsi
	push	edi
...
_pMenuMaybe$ = -4
_i$ = -8
_MNLookUpItem@16 PROC NEAR				; COMDAT
; Line 363
	push	ebp
	xor	eax, eax
	mov	ebp, esp
	...
	push	ebx
	mov	DWORD PTR _pMenuMaybe$[ebp], eax
	push	esi
	push	edi
; Line 370
	mov	esi, DWORD PTR _ppMenuItemIsOn$[ebp]
	cmp	esi, eax
	je	SHORT $L14436
; Line 371
...
; Line 373
$L14436:
	mov	edi, DWORD PTR _pMenu$[ebp]
	test	edi, edi
	je	$L14580
	mov	ecx, DWORD PTR [edi+40]
	test	ecx, ecx
	je	$L14580
	cmp	DWORD PTR _wCmd$[ebp], -1
	je	$L14580
; Line 381
	cmp	DWORD PTR _fByPosition$[ebp], 0
	je	SHORT $L14439
; Line 382
	cmp	ecx, DWORD PTR _wCmd$[ebp]
	jbe	$L14580
; Line 383
	mov	eax, DWORD PTR [edi+56]
	mov	ecx, DWORD PTR _wCmd$[ebp]
	shl	ecx, 6
...
; Line 414
	...
	jne	SHORT $L14447
; Line 415
	mov	DWORD PTR _pMenuMaybe$[ebp], edi
	mov	DWORD PTR _pItemMaybe$[ebp], ebx
; Line 419
$L14447:
; Line 420
	push	esi
...
$L14577:
; Line 434
	cmp	DWORD PTR _pMenuMaybe$[ebp], 0
	je	SHORT $L14580
; Line 437
	test	esi, esi
	je	SHORT $L14453
; Line 438
	mov	eax, DWORD PTR _pMenuMaybe$[ebp]
	mov	DWORD PTR [esi], eax
; Line 439
$L14453:
	mov	eax, DWORD PTR _pItemMaybe$[ebp]
	jmp	SHORT $L14578
; Line 422
$L14575:
; Line 428
...
$L14470:
; Line 511
	cmp	edx, DWORD PTR _pwndFind$[ebp]
	je	SHORT $L14595
; Line 513
	mov	ecx, edx
...
$L14595:
; Line 517
	sub	edx, DWORD PTR _pwndFind$[ebp]
	cmp	edx, 1
	sbb	eax, eax
	and	eax, ecx
; Line 518
...
$L14620:
; Line 695
	cmp	eax, DWORD PTR _pwndParent$[ebp]
	jne	SHORT $L14519
; Line 696
	mov	eax, 1
	jmp	SHORT $L14517
