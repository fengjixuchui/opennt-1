...
typedef /* [allocate] */ struct _LSAPR_TRUSTED_PASSWORD_INFO __RPC_FAR *PLSAPR_TRUSTED_PASSWORD_INFO;
...
typedef /* [allocate] */ PLSAPR_UNICODE_STRING PLSAPR_UNICODE_STRING_ARRAY;
