    ...
    PRPC_MESSAGE _pRpcMessage )
{
    ...
    RpcTryFinally
        ...
        SequenceNumber = &_M9;
        CASUuid = &_CASUuidM;
        OutData = _StubMsg.pfnAllocate(OutMaxLength * 1);
        pOutLength = &_M10;
        Status = &_M11;
...
/* 38 */	0x28,		/* 40 */
			0x0,		/*  */
/* 40 */	NdrFcShort( 0x10 ),	/*  Stack size/offset = 16 */
/* 42 */	0x1,		/* FC_BYTE */
			0x5b,		/* FC_END */
/* 44 */	
			0x1c,		/* FC_CVARRAY */
...
/* 48 */	0x28,		/* 40 */
			0x0,		/*  */
/* 50 */	NdrFcShort( 0x14 ),	/*  Stack size/offset = 20 */
/* 52 */	0x28,		/* 40 */
			0x54,		/* FC_DEREFERENCE */
/* 54 */	NdrFcShort( 0x24 ),	/*  Stack size/offset = 36 */
/* 56 */	0x1,		/* FC_BYTE */
			0x5b,		/* FC_END */
