...
extern const MIDL_SERVER_INFO llsdbgrpc_ServerInfo;

extern RPC_DISPATCH_TABLE llsdbgrpc_DispatchTable;

static const RPC_SERVER_INTERFACE llsdbgrpc___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0xF40E17F0,0x520F,0x11CE,{0xA8,0x97,0x08,0x00,0x2B,0x2E,0x9C,0x6D}},{0,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    &llsdbgrpc_DispatchTable,
    0,
    0,
    0,
    &llsdbgrpc_ServerInfo,
    0
    };
RPC_IF_HANDLE llsdbgrpc_ServerIfHandle = (RPC_IF_HANDLE)& llsdbgrpc___RpcServerInterface;
...
static const MIDL_STUB_DESC llsdbgrpc_StubDesc = 
    {
    (void __RPC_FAR *)& llsdbgrpc___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static RPC_DISPATCH_FUNCTION llsdbgrpc_table[] =
    {
    NdrServerCall,
    NdrServerCall,
    NdrServerCall,
...
RPC_DISPATCH_TABLE llsdbgrpc_DispatchTable = 
    {
    9,
    llsdbgrpc_table
    };

static const SERVER_ROUTINE llsdbgrpc_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)LlsrDbgTableDump,
    (SERVER_ROUTINE)LlsrDbgTableInfoDump,
    (SERVER_ROUTINE)LlsrDbgTableFlush,
    (SERVER_ROUTINE)LlsrDbgTraceSet,
    (SERVER_ROUTINE)LlsrDbgConfigDump,
    (SERVER_ROUTINE)LlsrDbgReplicationForce,
    (SERVER_ROUTINE)LlsrDbgReplicationDeny,
    (SERVER_ROUTINE)LlsrDbgRegistryUpdateForce,
    (SERVER_ROUTINE)LlsrDbgDatabaseFlush
    };

static const unsigned short llsdbgrpc_FormatStringOffsetTable[] = 
    {
    0,
    10,
    24,
...
static const MIDL_SERVER_INFO llsdbgrpc_ServerInfo = 
    {
    &llsdbgrpc_StubDesc,
    llsdbgrpc_ServerRoutineTable,
    __MIDL_ProcFormatString.Format,
    llsdbgrpc_FormatStringOffsetTable,
    0,
    0,
    0,
    0
