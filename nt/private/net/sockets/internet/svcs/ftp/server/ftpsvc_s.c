...
void __RPC_STUB
ftpsvc_FtprGetAdminInformation(
    PRPC_MESSAGE _pRpcMessage )
{
    LPFTP_CONFIG_INFO _M18;
    DWORD _RetVal;
    MIDL_STUB_MESSAGE _StubMsg;
    LPFTP_CONFIG_INFO __RPC_FAR *ppConfig;
    FTP_IMPERSONATE_HANDLE pszServer;
    RPC_STATUS _Status;
    ...
    RpcTryFinally
        ...
        _RetVal = FtprGetAdminInformation(pszServer,ppConfig);
...
void __RPC_STUB
ftpsvc_FtprSetAdminInformation(
    PRPC_MESSAGE _pRpcMessage )
{
    DWORD _RetVal;
    MIDL_STUB_MESSAGE _StubMsg;
    ...
    RpcTryFinally
        ...
        NdrPointerUnmarshall( (PMIDL_STUB_MESSAGE) &_StubMsg,
                              (unsigned char __RPC_FAR * __RPC_FAR *)&pConfig,
                              (PFORMAT_STRING) &__MIDL_TypeFormatString.Format[222],
                              (unsigned char)0 );
        
        
        _RetVal = FtprSetAdminInformation(pszServer,pConfig);
...
/* 64 */	
			...
			0x2,		/* Alpha Stack size = 2 */
#endif
/* 66 */	NdrFcShort( 0x9a ),	/* Type Offset=154 */
...
/* 74 */	
			...
			0x2,		/* Alpha Stack size = 2 */
#endif
/* 76 */	NdrFcShort( 0xde ),	/* Type Offset=222 */
