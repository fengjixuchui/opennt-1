...
static const RPC_CLIENT_INTERFACE w3svc___RpcClientInterface =
    {
...
RPC_IF_HANDLE w3svc_ClientIfHandle = (RPC_IF_HANDLE)& w3svc___RpcClientInterface;

extern const MIDL_STUB_DESC w3svc_StubDesc;

static RPC_BINDING_HANDLE w3svc__MIDL_AutoBindHandle;
    ...
    /* [out] */ LPW3_CONFIG_INFO __RPC_FAR *ppConfig)
{
    ...
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&w3svc_StubDesc,
    ...
    /* [unique][string][in] */ W3_IMPERSONATE_HANDLE pszServer)
{
    ...
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&w3svc_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[110],
                 vlist.a0);
#elif defined( _PPC_ ) || defined( _MIPS_ )
...
static const MIDL_STUB_DESC w3svc_StubDesc = 
    {
    (void __RPC_FAR *)& w3svc___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &w3_bhandle,
    0,
...
static const GENERIC_BINDING_ROUTINE_PAIR BindingRoutines[1] = 
        {
        {
            (GENERIC_BINDING_ROUTINE)W3_IMPERSONATE_HANDLE_bind,
            (GENERIC_UNBIND_ROUTINE)W3_IMPERSONATE_HANDLE_unbind
         }
