...
#ifdef UNICODE
#define TsInitializeInetLog  TsInitializeInetLogW
#else
#define TsInitializeInetLog  TsInitializeInetLogA
#endif // !UNICODE
...
#ifdef UNICODE
#define TsCreateInetLog  TsCreateInetLogW
#else
#define TsCreateInetLog  TsCreateInetLogA
#endif // !UNICODE
...
#ifdef UNICODE
#define TsLogInformation  TsLogInformationW
#else
#define TsLogInformation  TsLogInformationA
#endif // !UNICODE
...
#ifdef UNICODE
#define TsModifyLogConfiguration  TsModifyLogConfigurationW
#else
#define TsModifyLogConfiguration  TsModifyLogConfigurationA
#endif // !UNICODE
...
TsReadInetLogConfigurationW(
      IN LPCWSTR                       pszServiceName,
      IN LPCWSTR                       pszSvcRegParamKey,      // Optional
      OUT PINETLOG_CONFIGURATIONW       pInetLogConfiguration
      );
#ifdef UNICODE
#define TsReadInetLogConfiguration  TsReadInetLogConfigurationW
#else
#define TsReadInetLogConfiguration  TsReadInetLogConfigurationA
#endif // !UNICODE
...
TsWriteInetLogConfigurationA(
      ...
      IN LPCSTR                       pszSvcRegParamKey,     // Optional
      IN EVENT_LOG *                    pEventLog,
      IN const INETLOG_CONFIGURATIONA * pInetLogConfiguration
      );
dllexp
BOOL
TsWriteInetLogConfigurationW(
      ...
      IN LPCWSTR                       pszSvcRegParamKey,     // Optional
      IN EVENT_LOG *                    pEventLog,
      IN const INETLOG_CONFIGURATIONW * pInetLogConfiguration
      );
#ifdef UNICODE
#define TsWriteInetLogConfiguration  TsWriteInetLogConfigurationW
#else
#define TsWriteInetLogConfiguration  TsWriteInetLogConfigurationA
#endif // !UNICODE
