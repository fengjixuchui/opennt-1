 ...
 */
/* Compiler settings for .\info.idl, infocli.acf:
...
static const RPC_CLIENT_INTERFACE inetinfo___RpcClientInterface =
    {
...
RPC_IF_HANDLE inetinfo_ClientIfHandle = (RPC_IF_HANDLE)& inetinfo___RpcClientInterface;

extern const MIDL_STUB_DESC inetinfo_StubDesc;

static RPC_BINDING_HANDLE inetinfo__MIDL_AutoBindHandle;
    ...
    /* [out] */ DWORD __RPC_FAR *pdwVersion)
{
...
#if defined( _ALPHA_ )
    va_start(vlist,pdwVersion);
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&inetinfo_StubDesc,
    ...
    _RetVal = NdrClientCall(
                 ...
                 ( unsigned char __RPC_FAR * )&dwReserved,
                 ( unsigned char __RPC_FAR * )&pdwVersion);
#else
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&inetinfo_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[0],
    ...
    /* [out] */ LPINET_INFO_CONFIG_INFO __RPC_FAR *ppConfig)
{
    ...
    _RetVal = NdrClientCall(
                 ...
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[24],
                 ( unsigned char __RPC_FAR * )&pszServer,
                 ( unsigned char __RPC_FAR * )&dwServerMask,
...
#if defined( _ALPHA_ )
    va_start(vlist,dwServerMask);
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&inetinfo_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[146],
                 vlist.a0);
#elif defined( _PPC_ ) || defined( _MIPS_ )
...
static const MIDL_STUB_DESC inetinfo_StubDesc = 
    {
    (void __RPC_FAR *)& inetinfo___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &inetinfo__MIDL_AutoBindHandle,
    0,
    BindingRoutines,
    0,
    0,
...
static const GENERIC_BINDING_ROUTINE_PAIR BindingRoutines[1] = 
        {
        {
            (GENERIC_BINDING_ROUTINE)INET_INFO_IMPERSONATE_HANDLE_bind,
            (GENERIC_UNBIND_ROUTINE)INET_INFO_IMPERSONATE_HANDLE_unbind
         }
