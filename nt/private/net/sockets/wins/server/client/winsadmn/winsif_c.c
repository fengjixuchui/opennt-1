    ...
    /* [in] */ short fAbruptTem)
{
    ...
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&winsif_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[86],
                 ( unsigned char __RPC_FAR * )&ClientHdl,
                 ( unsigned char __RPC_FAR * )&fAbruptTem);
#else
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&winsif_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[86],
    ...
    /* [in] */ short fIncremental)
{
    ...
    _RetVal = NdrClientCall(
                 ...
                 ( unsigned char __RPC_FAR * )&fIncremental);
#else
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&winsif_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[102],
...
#if defined( _ALPHA_ )
    va_start(vlist,MaxVersNo);
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&winsif_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[116],
                 vlist.a0);
#elif defined( _PPC_ ) || defined( _MIPS_ )
    ...
    /* [in] */ DWORD NewNoOfNbtThds)
{
    ...
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&winsif_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[178],
                 ( unsigned char __RPC_FAR * )&NewNoOfNbtThds);
#else
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&winsif_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[178],
...
#if defined( _ALPHA_ )
    va_start(vlist,pUncName);
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&winsif_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[188],
                 vlist.a0);
#elif defined( _PPC_ ) || defined( _MIPS_ )
    ...
    /* [in] */ DWORD fFlags)
{
    ...
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&winsif_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[228],
                 ( unsigned char __RPC_FAR * )&fFlags);
#else
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&winsif_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[228],
    ...
    /* [out] */ PWINSINTF_RECS_T pRecs)
{
    ...
    _RetVal = NdrClientCall(
                 ...
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[260],
                 ( unsigned char __RPC_FAR * )&pWinsAdd,
                 ( unsigned char __RPC_FAR * )&Location,
                 ( unsigned char __RPC_FAR * )&pName,
                 ( unsigned char __RPC_FAR * )&NameLen,
                 ( unsigned char __RPC_FAR * )&NoOfRecsDesired,
                 ( unsigned char __RPC_FAR * )&fOnlyStatic,
                 ( unsigned char __RPC_FAR * )&pRecs);
#else
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&winsif_StubDesc,
    ...
    /* [ref][out][in] */ PWINSINTF_RESULTS_NEW_T pResults)
{
    ...
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&winsif_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[302],
                 vlist.a0);
#elif defined( _PPC_ ) || defined( _MIPS_ )
...
#if defined( _ALPHA_ )
    va_start(vlist,pScvReq);
    _RetVal = NdrClientCall(
                 ( PMIDL_STUB_DESC  )&winsif_StubDesc,
                 (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[326],
                 vlist.a0);
#elif defined( _PPC_ ) || defined( _MIPS_ )
...
static const GENERIC_BINDING_ROUTINE_PAIR BindingRoutines[1] = 
        {
        {
            (GENERIC_BINDING_ROUTINE)WINSIF_HANDLE_bind,
            (GENERIC_UNBIND_ROUTINE)WINSIF_HANDLE_unbind
         }
