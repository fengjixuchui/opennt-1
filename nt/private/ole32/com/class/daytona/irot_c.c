...
RPC_IF_HANDLE IROT_ClientIfHandle = (RPC_IF_HANDLE)& IROT___RpcClientInterface;
    ...
    /* [fault_status][comm_status][out] */ error_status_t __RPC_FAR *prpcstat)
{
    ...
    _RetVal = NdrClientCall2(
                  ...
                  ( unsigned char __RPC_FAR * )&pwszWinstaDesktop,
                  ( unsigned char __RPC_FAR * )&pmkeqbuf,
                  ( unsigned char __RPC_FAR * )&pifdObject,
                  ( unsigned char __RPC_FAR * )&pifdObjectName,
                  ( unsigned char __RPC_FAR * )&pfiletime,
                  ( unsigned char __RPC_FAR * )&dwProcessId,
                  ( unsigned char __RPC_FAR * )&pwszServerExe,
                  ( unsigned char __RPC_FAR * )&psrkRegister,
    ...
    /* [fault_status][comm_status][out] */ error_status_t __RPC_FAR *prpcstat)
{
    ...
    _RetVal = NdrClientCall2(
                  ...
                  ( unsigned char __RPC_FAR * )&hRpc,
                  ( unsigned char __RPC_FAR * )&psrkRegister,
                  ( unsigned char __RPC_FAR * )&fServerRevoke,
                  ( unsigned char __RPC_FAR * )&pifdObject,
                  ( unsigned char __RPC_FAR * )&pifdName,
                  ( unsigned char __RPC_FAR * )&prpcstat);
#else
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IROT_StubDesc,
    ...
    /* [fault_status][comm_status][out] */ error_status_t __RPC_FAR *prpcstat)
{
    ...
    _RetVal = NdrClientCall2(
                  ...
                  ( unsigned char __RPC_FAR * )&phProcess,
                  ( unsigned char __RPC_FAR * )&pwszWinstaDesktop,
                  ( unsigned char __RPC_FAR * )&ppMkIFList,
                  ( unsigned char __RPC_FAR * )&prpcstat);
#else
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IROT_StubDesc,
...
static const COMM_FAULT_OFFSETS IROT_CommFaultOffsets[] = 
{
#ifdef _X86_
	{ 40, 40 },	/* x86 Offsets for IrotRegister */
#endif
#if defined(_MIPS_) || defined(_PPC_)
	{ 40, 40 },	/* MIPS, PPC Offsets for IrotRegister */
#endif
#ifdef _ALPHA_
	{ 80, 80 },	/* Alpha Offsets for IrotRegister */
#endif
#ifdef _X86_
	{ 20, 20 },	/* x86 Offsets for IrotRevoke */
#endif
#if defined(_MIPS_) || defined(_PPC_)
	{ 20, 20 },	/* MIPS, PPC Offsets for IrotRevoke */
#endif
#ifdef _ALPHA_
	{ 40, 40 },	/* Alpha Offsets for IrotRevoke */
#endif
#ifdef _X86_
	{ 16, 16 },	/* x86 Offsets for IrotIsRunning */
#endif
#if defined(_MIPS_) || defined(_PPC_)
	{ 16, 16 },	/* MIPS, PPC Offsets for IrotIsRunning */
#endif
#ifdef _ALPHA_
	{ 32, 32 },	/* Alpha Offsets for IrotIsRunning */
#endif
#ifdef _X86_
	{ 28, 28 },	/* x86 Offsets for IrotGetObject */
#endif
#if defined(_MIPS_) || defined(_PPC_)
	{ 28, 28 },	/* MIPS, PPC Offsets for IrotGetObject */
#endif
#ifdef _ALPHA_
	{ 56, 56 },	/* Alpha Offsets for IrotGetObject */
#endif
#ifdef _X86_
	{ 12, 12 },	/* x86 Offsets for IrotNoteChangeTime */
#endif
#if defined(_MIPS_) || defined(_PPC_)
	{ 12, 12 },	/* MIPS, PPC Offsets for IrotNoteChangeTime */
#endif
#ifdef _ALPHA_
	{ 24, 24 },	/* Alpha Offsets for IrotNoteChangeTime */
#endif
#ifdef _X86_
	{ 20, 20 },	/* x86 Offsets for IrotGetTimeOfLastChange */
#endif
#if defined(_MIPS_) || defined(_PPC_)
	{ 20, 20 },	/* MIPS, PPC Offsets for IrotGetTimeOfLastChange */
#endif
#ifdef _ALPHA_
	{ 40, 40 },	/* Alpha Offsets for IrotGetTimeOfLastChange */
#endif
#ifdef _X86_
	{ 16, 16 } 	/* x86 Offsets for IrotEnumRunning */
#endif
#if defined(_MIPS_) || defined(_PPC_)
	{ 16, 16 } 	/* MIPS, PPC Offsets for IrotEnumRunning */
#endif
#ifdef _ALPHA_
	{ 32, 32 } 	/* Alpha Offsets for IrotEnumRunning */
#endif
};
...
static const MIDL_STUB_DESC IROT_StubDesc = 
    {
    (void __RPC_FAR *)& IROT___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &any_handle,
    0,
