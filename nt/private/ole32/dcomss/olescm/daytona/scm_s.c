...
extern const MIDL_SERVER_INFO ISCM_ServerInfo;
...
static const SERVER_ROUTINE ISCM_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)ServerRegisterClsid,
    (SERVER_ROUTINE)ServerRevokeClsid,
    (SERVER_ROUTINE)GetThreadID,
    (SERVER_ROUTINE)UpdateShrdTbls,
    (SERVER_ROUTINE)UpdateActivationSettings,
    (SERVER_ROUTINE)RegisterWindowPropInterface,
    (SERVER_ROUTINE)GetWindowPropInterface
    };

static const unsigned short ISCM_FormatStringOffsetTable[] = 
    {
    0,
    52,
    86,
...
static const MIDL_SERVER_INFO ISCM_ServerInfo = 
    {
    &ISCM_StubDesc,
    ISCM_ServerRoutineTable,
    __MIDL_ProcFormatString.Format,
    ISCM_FormatStringOffsetTable,
    0,
    0,
    0,
    0
