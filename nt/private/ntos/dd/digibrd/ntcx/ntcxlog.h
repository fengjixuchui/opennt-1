...
//
#define SERIAL_REGISTRY_VALUE_NOT_FOUND  ((NTSTATUS)0xC0061007L)
...
//
#define SERIAL_FILE_NOT_FOUND            ((NTSTATUS)0xC0061008L)
...
//
#define STATUS_DEVICE_NOT_INITIALIZED    ((NTSTATUS)0xC0061009L)
