...
//
// MessageId: SERIAL_RESIZING_WINDOW
//
// MessageText:
//
//  Overriding current configuration to use 8K memory mapped window on %2.
//
#define SERIAL_RESIZING_WINDOW           ((NTSTATUS)0x40061007L)
...
//
// MessageId: SERIAL_UNSUPPORTED_CONTROLLER
//
// MessageText:
//
//  Controller %2 is an unsupported controller.
//
#define SERIAL_UNSUPPORTED_CONTROLLER    ((NTSTATUS)0xC0061009L)
...
//
#define SERIAL_FILE_NOT_FOUND            ((NTSTATUS)0xC006100AL)
...
//
#define STATUS_DEVICE_NOT_INITIALIZED    ((NTSTATUS)0xC006100BL)
