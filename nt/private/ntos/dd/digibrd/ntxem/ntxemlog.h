...
//
// MessageId: SERIAL_NO_XEM_MODULES
//
// MessageText:
//
//  No Xem PORTS modules were found connected to %2.  Shutdown system, turn off your computer and connect an Xem PORTS module.
//
#define SERIAL_NO_XEM_MODULES            ((NTSTATUS)0xC0061007L)
