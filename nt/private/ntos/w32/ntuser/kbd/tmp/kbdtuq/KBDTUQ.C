...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Turkish Q
\***************************************************************************/
...
*
* Turkish Q Keyboard has only three shifter keys:
...
//                      |=========|=========|
  ...
  {'N'          ,CAPLOK ,'n'      ,'N'      },
  {'M'          ,CAPLOK ,'m'      ,'M'      },
  {VK_OEM_2     ,CAPLOK ,0x00f6   ,0x00d6   },
  {VK_OEM_5     ,CAPLOK ,0x00e7   ,0x00c7   },
  {VK_OEM_PERIOD,0      ,'.'      ,':'      },
  {VK_DECIMAL   ,0      ,','      ,','      },
  {VK_TAB       ,0      ,'\t'     ,'\t'     },
  {VK_ADD       ,0      ,'+'      ,'+'      },
...
//                      |=========|=========|=========|=========|
  ...
  {VK_OEM_COMMA ,0      ,','      ,';'      ,WCH_DEAD ,0x001c   },
  {0xff         ,0      ,WCH_NONE ,WCH_NONE ,'`'      ,WCH_NONE },
  {VK_OEM_102   ,0      ,'<'      ,'>'      ,'|'      ,0x001c   },
...
static DEADKEY aDeadKey[] = {
    ...
    DEADTRANS( 0x0131 , 0x00b4 , 0x00ed ),
    ...
    DEADTRANS( 0x0130 , 0x00b4 , 0x00cd ),
    ...
    DEADTRANS( 0x0131 , 0x00a8 , 0x00ef ),
    ...
    DEADTRANS( 0x0130 , 0x00a8 , 0x00cf ),
