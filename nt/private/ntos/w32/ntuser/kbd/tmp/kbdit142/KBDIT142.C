...
*
* keyboard layout for Italian 142
*
...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Italian 142
\***************************************************************************/
...
*
* Italian 142 Keyboard has only three shifter keys:
...
//                      |=========|=========|
  ...
  {'K'          ,CAPLOK ,'k'      ,'K'      },
  {'L'          ,CAPLOK ,'l'      ,'L'      },
  {VK_OEM_3     ,0      ,0x00f2   ,0x00e7   },
  {VK_OEM_7     ,0      ,0x00e0   ,0x00b0   },
  {VK_OEM_5     ,0      ,'\\'     ,'|'      },
  {'Z'          ,CAPLOK ,'z'      ,'Z'      },
  {'X'          ,CAPLOK ,'x'      ,'X'      },
  {'C'          ,CAPLOK ,'c'      ,'C'      },
