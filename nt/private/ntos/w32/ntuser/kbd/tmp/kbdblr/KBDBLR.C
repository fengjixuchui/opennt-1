/***************************************************************************\
* Module Name: KBDBLR.C
*
* keyboard layout for Belarussia
*
...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Belarussia
\***************************************************************************/
...
*
* Belarussia Keyboard has only three shifter keys:
...
//                      |=========|=========|=========|
  ...
  {VK_OEM_6     ,CAPLOK ,0x045e   ,0x040e   ,0x001b   },
