/***************************************************************************\
* Module Name: KBDYCC.C
*
* keyboard layout for Serbian_Cyrillic
*
...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Serbian_Cyrillic
\***************************************************************************/
...
*
* Serbian_Cyrillic Keyboard has only three shifter keys:
...
static DEADKEY aDeadKey[] = {
    DEADTRANS( 0x0433 , '\''   , 0x0453 ),
    DEADTRANS( 0x0413 , '\''   , 0x0403 ),
    DEADTRANS( 0x043a , '\''   , 0x045c ),
    DEADTRANS( 0x041a , '\''   , 0x040c ),
    DEADTRANS( L' '   , '\''   , '\''   ),
