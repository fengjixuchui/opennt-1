...
* Module Name: KBDLV.C
*
* keyboard layout for Latvia
*
* Copyright (c) 1985-95, Microsoft Corporation
*
* History:
* KBDTOOL v1.03 - Created  Tue Oct 08 22:12:08 2019
\***************************************************************************/
...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Latvia
\***************************************************************************/
...
*
* Latvia Keyboard has only three shifter keys:
...
//                      |=========|=========|
  ...
  {'N'          ,CAPLOK ,'n'      ,'N'      },
  {'Z'          ,CAPLOK ,'z'      ,'Z'      },
  {'W'          ,CAPLOK ,0x0113   ,0x0112   },
  {'X'          ,CAPLOK ,0x010d   ,0x010c   },
  {VK_OEM_1     ,CAPLOK ,0x0161   ,0x0160   },
  {'U'          ,CAPLOK ,'u'      ,'U'      },
  {'S'          ,CAPLOK ,'s'      ,'S'      },
  {'I'          ,CAPLOK ,'i'      ,'I'      },
  {'L'          ,CAPLOK ,'l'      ,'L'      },
  ...
  {VK_OEM_3     ,0      ,0x00ad   ,'?'      },
  {'P'          ,CAPLOK ,'p'      ,'P'      },
  {VK_OEM_8     ,CAPLOK ,0x0101   ,0x0100   },
  {VK_OEM_2     ,CAPLOK ,0x013c   ,0x013b   },
  {VK_DECIMAL   ,0      ,','      ,0x0008   },
  {VK_TAB       ,0      ,'\t'     ,'\t'     },
  {VK_ADD       ,0      ,'+'      ,'+'      },
  {VK_DIVIDE    ,0      ,'/'      ,'/'      },
...
//                      |=========|=========|=========|=========|
  {'2'          ,0      ,'2'      ,0x00ab   ,WCH_NONE ,'@'      },
  {'3'          ,0      ,'3'      ,0x00bb   ,WCH_NONE ,'#'      },
  {'4'          ,0      ,'4'      ,'$'      ,WCH_NONE ,'$'      },
  {'5'          ,0      ,'5'      ,'%'      ,'\"'     ,WCH_DEAD },
  {0xff         ,0      ,WCH_NONE ,WCH_NONE ,WCH_NONE ,'~'      },
  {'7'          ,0      ,'7'      ,'&'      ,WCH_NONE ,0x00b1   },
  {'F'          ,CAPLOK ,'f'      ,'F'      ,'='      ,';'      },
  {'Q'          ,CAPLOK ,0x016b   ,0x016a   ,'q'      ,'Q'      },
  {'G'          ,CAPLOK ,'g'      ,'G'      ,0x0123   ,0x0122   },
  {'R'          ,CAPLOK ,'r'      ,'R'      ,0x0157   ,0x0156   },
  {'M'          ,CAPLOK ,'m'      ,'M'      ,'w'      ,'W'      },
  {'V'          ,CAPLOK ,'v'      ,'V'      ,'y'      ,'Y'      },
  {'Y'          ,CAPLOK ,0x017e   ,0x017d   ,'['      ,'{'      },
  {'H'          ,CAPLOK ,'h'      ,'H'      ,']'      ,'}'      },
  {VK_OEM_7     ,0      ,WCH_DEAD ,WCH_DEAD ,WCH_DEAD ,WCH_DEAD },
  {0xff         ,0      ,0x00b4   ,0x00b0   ,0x00b4   ,0x00d8   },
  {'B'          ,CAPLOK ,'b'      ,'B'      ,'x'      ,'X'      },
...
//                      |=========|=========|=========|=========|=========|
  {VK_OEM_5     ,CAPLOK ,0x0137   ,0x0136   ,WCH_NONE ,WCH_NONE ,0x001c   },
  {VK_OEM_4     ,CAPLOK ,0x0146   ,0x0145   ,WCH_NONE ,WCH_NONE ,0x001b   },
  {VK_OEM_6     ,CAPLOK ,0x012b   ,0x012a   ,WCH_NONE ,WCH_NONE ,0x001d   },
  {VK_OEM_102   ,CAPLOK ,0x0123   ,0x0122   ,'\\'     ,'|'      ,0x001c   },
