/***************************************************************************\
* Module Name: KBDHE319.C
*
* keyboard layout for Greek IBM 319
*
* Copyright (c) 1985-95, Microsoft Corporation
*
* History:
* KBDTOOL v1.03 - Created  Thu Oct 17 16:38:13 2019
\***************************************************************************/
...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Greek IBM 319
\***************************************************************************/
...
*
* Greek IBM 319 Keyboard has only three shifter keys:
...
//                      |=========|=========|
  ...
  {'0'          ,0      ,'0'      ,'='      },
  {VK_OEM_PLUS  ,0      ,'+'      ,'*'      },
  {'Q'          ,CAPLOK ,0x00b7   ,0x2015   },
  {'W'          ,CAPLOK ,0x03c2   ,0x00a6   },
  {'E'          ,CAPLOK ,0x03b5   ,0x0395   },
  {'R'          ,CAPLOK ,0x03c1   ,0x03a1   },
  {'T'          ,CAPLOK ,0x03c4   ,0x03a4   },
  {'Y'          ,CAPLOK ,0x03c5   ,0x03a5   },
  ...
  {VK_OEM_7     ,0      ,0x2019   ,0x2018   },
  {VK_OEM_3     ,0      ,0x00bd   ,0x00b1   },
  {'Z'          ,CAPLOK ,0x03b6   ,0x0396   },
  {'X'          ,CAPLOK ,0x03c7   ,0x03a7   },
  {'C'          ,CAPLOK ,0x03c8   ,0x03a8   },
...
//                      |=========|=========|=========|=========|
  ...
  {VK_OEM_5     ,0      ,0x00b2   ,0x00b3   ,WCH_NONE ,0x001c   },
  {VK_OEM_102   ,0      ,0x00a7   ,0x00a9   ,WCH_NONE ,0x001c   },
...
//                      |=========|=========|=========|=========|=========|
  {'2'          ,0      ,'2'      ,'\"'     ,WCH_NONE ,WCH_NONE ,0x0000   },
  {'6'          ,0      ,'6'      ,0x00ac   ,WCH_NONE ,WCH_NONE ,0x001e   },
  {VK_OEM_2     ,0      ,'\''     ,0x00b0   ,WCH_NONE ,WCH_NONE ,0x001f   },
  {0            ,0      ,0        ,0        ,0        ,0        ,0        }
};
...
static DEADKEY aDeadKey[] = {
    DEADTRANS( 0x03b1 , 0x0384 , 0x03ac ),
    DEADTRANS( 0x03b5 , 0x0384 , 0x03ad ),
    DEADTRANS( 0x03b9 , 0x0384 , 0x03af ),
    DEADTRANS( 0x03bf , 0x0384 , 0x03cc ),
    DEADTRANS( 0x03c5 , 0x0384 , 0x03cd ),
    DEADTRANS( 0x03c9 , 0x0384 , 0x03ce ),
    DEADTRANS( 0x03b7 , 0x0384 , 0x03ae ),
    DEADTRANS( 0x0391 , 0x0384 , 0x0386 ),
    DEADTRANS( 0x0395 , 0x0384 , 0x0388 ),
    DEADTRANS( 0x0399 , 0x0384 , 0x038a ),
    DEADTRANS( 0x039f , 0x0384 , 0x038c ),
    DEADTRANS( 0x03a5 , 0x0384 , 0x038e ),
    DEADTRANS( 0x03a9 , 0x0384 , 0x038f ),
    DEADTRANS( 0x0397 , 0x0384 , 0x0389 ),
    DEADTRANS( L' '   , 0x0384 , 0x0384 ),

    DEADTRANS( 0x03b9 , 0x00a8 , 0x03ca ),
    DEADTRANS( 0x03c5 , 0x00a8 , 0x03cb ),
    DEADTRANS( 0x0399 , 0x00a8 , 0x03aa ),
    DEADTRANS( 0x03a5 , 0x00a8 , 0x03ab ),
    DEADTRANS( L' '   , 0x00a8 , 0x00a8 ),

    DEADTRANS( 0x03b9 , 0x0385 , 0x0390 ),
    DEADTRANS( 0x03c5 , 0x0385 , 0x03b0 ),
    DEADTRANS( L' '   , 0x0385 , 0x0385 ),
