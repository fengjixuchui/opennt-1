...
* Module Name: KBDES.C
*
* keyboard layout for Spanish Alernate
*
...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Spanish Alernate
\***************************************************************************/
...
*
* Spanish Alernate Keyboard has only three shifter keys:
...
//                      |         |  Shift  |  Ctl+Alt|  Ctrl   |
//                      |=========|=========|=========|=========|
  {VK_OEM_6     ,CAPLOK ,0x00f7   ,0x00d7   ,'['      ,0x001b   },
  {VK_OEM_1     ,0      ,WCH_DEAD ,WCH_DEAD ,']'      ,0x001d   },
  {0xff         ,0      ,'`'      ,'`'      ,WCH_NONE ,WCH_NONE },
  {VK_OEM_2     ,0      ,WCH_DEAD ,WCH_DEAD ,'}'      ,0x001c   },
  {0xff         ,0      ,0x00b4   ,0x00b4   ,WCH_NONE ,WCH_NONE },
...
//                      |=========|=========|=========|=========|=========|
  {'6'          ,0      ,'6'      ,0x00a1   ,0x00ac   ,WCH_NONE ,0x001e   },
  {0            ,0      ,0        ,0        ,0        ,0        ,0        }
};
