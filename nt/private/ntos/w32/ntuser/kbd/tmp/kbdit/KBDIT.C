...
*
* History:
* KBDTOOL v1.03 - Created  Tue Oct 08 22:12:07 2019
\***************************************************************************/
...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Italian
\***************************************************************************/
...
*
* Italian Keyboard has only three shifter keys:
...
//                      |         |  Shift  |  Ctrl   |
//                      |=========|=========|=========|
  {'3'          ,0      ,'3'      ,0x00a3   ,WCH_NONE },
  {'7'          ,0      ,'7'      ,'/'      ,WCH_NONE },
  {'8'          ,0      ,'8'      ,'('      ,WCH_NONE },
  {'9'          ,0      ,'9'      ,')'      ,WCH_NONE },
  {'0'          ,0      ,'0'      ,'='      ,WCH_NONE },
  {'Q'          ,CAPLOK ,'q'      ,'Q'      ,WCH_NONE },
  {VK_OEM_2     ,0      ,0x00f9   ,0x00a7   ,0x001c   },
...
//                      |=========|=========|=========|=========|=========|
  {VK_OEM_1     ,0      ,0x00e8   ,0x00e9   ,0x001b   ,'['      ,'{'      },
  {VK_OEM_PLUS  ,0      ,'+'      ,'*'      ,0x001d   ,']'      ,'}'      },
  {VK_OEM_3     ,0      ,0x00f2   ,0x00e7   ,WCH_NONE ,'@'      ,WCH_NONE },
  {VK_OEM_7     ,0      ,0x00e0   ,0x00b0   ,WCH_NONE ,'#'      ,WCH_NONE },
  {0            ,0      ,0        ,0        ,0        ,0        ,0        }
};

static VK_TO_WCHARS6 aVkToWch6[] = {
//                      |         |  Shift  |  Ctrl   |  Ctl+Alt|S+Ctl+Alt|S+Ctrl   |
//                      |=========|=========|=========|=========|=========|=========|
...
static VSC_LPWSTR aKeyNamesExt[] = {
    ...
    0x4f,    L"FINE",
    0x50,    L"Freccia GI\x00D9" L"",
    0x51,    L"PGGI\x00D9",
    0x52,    L"INS",
    0x54,    L"<00>",
    0x56,    L"AIUTO",
    0x53,    L"CANCELLA",
    0x5b,    L"WINDOWS SINISTRO",
    0x5c,    L"WINDOWS DESTRO",
    0x5d,    L"APPLICAZIONE",
    0   ,    NULL
};
