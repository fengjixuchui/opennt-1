...
* Module Name: KBDDV.C
*
* keyboard layout for Dvorak US English
*
...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Dvorak US English
\***************************************************************************/
...
*
* Dvorak US English Keyboard has only three shifter keys:
