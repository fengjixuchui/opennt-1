/***************************************************************************\
* Module Name: KBDYCL.C
*
* keyboard layout for Serbian_Latin
*
...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Serbian_Latin
\***************************************************************************/
...
*
* Serbian_Latin Keyboard has only three shifter keys:
...
static DEADKEY aDeadKey[] = {
    DEADTRANS( L'k'   , '\''   , 0x045c ),
    DEADTRANS( L'K'   , '\''   , 0x040c ),
    DEADTRANS( L'g'   , '\''   , 0x0453 ),
    DEADTRANS( L'G'   , '\''   , 0x0403 ),
    DEADTRANS( L' '   , '\''   , '\''   ),
