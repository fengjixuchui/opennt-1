...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Norwegian
\***************************************************************************/
...
//                      |=========|=========|
  ...
  {'K'          ,CAPLOK ,'k'      ,'K'      },
  {'L'          ,CAPLOK ,'l'      ,'L'      },
  {VK_OEM_3     ,CAPLOK ,0x00f8   ,0x00d8   },
  {VK_OEM_7     ,CAPLOK ,0x00e6   ,0x00c6   },
  {VK_OEM_2     ,0      ,'\''     ,'*'      },
  {'Z'          ,CAPLOK ,'z'      ,'Z'      },
  {'X'          ,CAPLOK ,'x'      ,'X'      },
  {'C'          ,CAPLOK ,'c'      ,'C'      },
...
//                      |         |  Shift  |  Ctl+Alt|  Ctrl   |
//                      |=========|=========|=========|=========|
  {VK_OEM_6     ,CAPLOK ,0x00e5   ,0x00c5   ,WCH_NONE ,0x001b   },
  {VK_OEM_1     ,0      ,WCH_DEAD ,WCH_DEAD ,WCH_DEAD ,0x001d   },
  {0xff         ,0      ,0x00a8   ,'^'      ,'~'      ,WCH_NONE },
  {VK_OEM_5     ,0      ,'|'      ,0x00a7   ,WCH_NONE ,0x001c   },
...
static VSC_LPWSTR aKeyNamesExt[] = {
    ...
    0x5c,    L"H\x00F8" L"yre Windows",
    0x5d,    L"Program",
    0   ,    NULL
};

static LPWSTR aKeyNamesDead[] = {
    L"\x00b4"	L"AKUTT AKSENT \x00B4" L"",
    L"`"	L"GRAV",
    L"^"	L"CIRKUMFLEKS",
    L"\x00a8"	L"T\x00D8" L"DLER",
    L"~"	L"TILDE",
    NULL
};
