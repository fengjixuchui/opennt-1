/***************************************************************************\
* Module Name: KBDBENE.C
*
* keyboard layout for Belgian Dutch
*
* Copyright (c) 1985-95, Microsoft Corporation
*
* History:
* KBDTOOL v1.03 - Created  Thu Oct 17 16:38:10 2019
\***************************************************************************/
...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Belgian Dutch
\***************************************************************************/
...
*
* Belgian Dutch Keyboard has only three shifter keys:
...
//                      |         |  Shift  |  Ctl+Alt|  Ctrl   |
//                      |=========|=========|=========|=========|
  {VK_OEM_MINUS ,CAPLOK ,'-'      ,'_'      ,WCH_NONE ,0x001f   },
  {VK_OEM_6     ,CAPLOK ,WCH_DEAD ,WCH_DEAD ,'['      ,0x001b   },
  {0xff         ,0      ,'^'      ,0x00a8   ,WCH_NONE ,WCH_NONE },
...
//                      |=========|=========|=========|=========|=========|
  {'6'          ,CAPLOK ,0x00a7   ,'6'      ,'^'      ,WCH_NONE ,0x001e   },
  {0            ,0      ,0        ,0        ,0        ,0        ,0        }
};

static VK_TO_WCHARS6 aVkToWch6[] = {
//                      |         |  Shift  |  Ctl+Alt|  Ctrl   |S+Ctrl   |S+Ctl+Alt|
//                      |=========|=========|=========|=========|=========|=========|
  {VK_OEM_3     ,CAPLOK ,0x00f9   ,'%'      ,WCH_DEAD ,WCH_NONE ,WCH_NONE ,WCH_DEAD },
  {0xff         ,0      ,WCH_NONE ,WCH_NONE ,0x00b4   ,WCH_NONE ,WCH_NONE ,0x00b4   },
  {VK_OEM_5     ,CAPLOK ,0x00b5   ,0x00a3   ,WCH_DEAD ,0x001c   ,WCH_NONE ,WCH_DEAD },
