/***************************************************************************\
* Module Name: KBDSL1.C
*
* keyboard layout for Slovak(QWERTY)
*
...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Slovak(QWERTY)
\***************************************************************************/
...
*
* Slovak(QWERTY) Keyboard has only three shifter keys:
...
//                      |=========|=========|=========|=========|
  ...
  {VK_OEM_6     ,0      ,0x00e4   ,'('      ,0x00d7   ,0x001b   },
  {VK_OEM_1     ,0      ,0x00f4   ,'\"'     ,'$'      ,0x001d   },
