...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Hungarian
\***************************************************************************/
...
*
* Hungarian Keyboard has only three shifter keys:
...
//                      |=========|=========|=========|
  ...
  {VK_OEM_2     ,CAPLOK ,0x00fc   ,0x00dc   ,WCH_DEAD },
  {0xff         ,0      ,WCH_NONE ,WCH_NONE ,0x00a8   },
  {VK_OEM_PLUS  ,CAPLOK ,0x00f3   ,0x00d3   ,WCH_DEAD },
...
static LPWSTR aKeyNamesDead[] = {
    ...
    L"^"	L"Circumflex",
    L"0"	L"\x02D8" L"Breve",
    L"0"	L"\x00B0" L"Ring Above",
    L"0"	L"\x02DB" L"Ogonek",
    L"0"	L"\x02D9" L"Dot Above",
    L"0"	L"\x00B4" L"Acute",
    L"0"	L"\x02DD" L"Double Acute",
    L"0"	L"\x00A8" L"Diaeresis",
    L"0"	L"\x00B8" L"Cedilla",
    NULL
};
