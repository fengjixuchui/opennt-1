...
*
* keyboard layout for Dvorak Left-Hand US English
*
...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Dvorak Left-Hand US English
\***************************************************************************/
...
*
* Dvorak Left-Hand US English Keyboard has only three shifter keys:
