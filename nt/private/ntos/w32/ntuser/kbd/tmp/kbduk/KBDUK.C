...
* Module Name: KBDUK.C
*
* keyboard layout for United Kingdom
*
* Copyright (c) 1985-95, Microsoft Corporation
*
* History:
* KBDTOOL v1.03 - Created  Tue Oct 08 22:12:11 2019
\***************************************************************************/
...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for United Kingdom
\***************************************************************************/
...
//                      |=========|=========|=========|=========|
  ...
  {VK_OEM_3     ,0      ,'\''     ,'@'      ,WCH_NONE ,0x0000   },
  {0            ,0      ,0        ,0        ,0        ,0        }
};

static VK_TO_WCHARS5 aVkToWch5[] = {
//                      |         |  Shift  |  Ctrl   |S+Ctrl   |  Ctl+Alt|
//                      |=========|=========|=========|=========|=========|
  {VK_OEM_8     ,0      ,'`'      ,0x00ac   ,WCH_NONE ,WCH_NONE ,0x00a6   },
  {0            ,0      ,0        ,0        ,0        ,0        ,0        }
};
...
//                      |=========|=========|=========|=========|=========|=========|
  {'E'          ,CAPLOK | CAPLOKALTGR,'e'      ,'E'      ,WCH_NONE ,WCH_NONE ,0x00e9   ,0x00c9   },
  {'U'          ,CAPLOK | CAPLOKALTGR,'u'      ,'U'      ,WCH_NONE ,WCH_NONE ,0x00fa   ,0x00da   },
  {'I'          ,CAPLOK | CAPLOKALTGR,'i'      ,'I'      ,WCH_NONE ,WCH_NONE ,0x00ed   ,0x00cd   },
  {'O'          ,CAPLOK | CAPLOKALTGR,'o'      ,'O'      ,WCH_NONE ,WCH_NONE ,0x00f3   ,0x00d3   },
  {'A'          ,CAPLOK | CAPLOKALTGR,'a'      ,'A'      ,WCH_NONE ,WCH_NONE ,0x00e1   ,0x00c1   },
  {0            ,0      ,0        ,0        ,0        ,0        ,0        ,0        }
};
