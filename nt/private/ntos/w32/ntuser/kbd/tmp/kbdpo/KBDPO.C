...
* Module Name: KBDPO.C
*
* keyboard layout for Portuguese
*
...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Portuguese
\***************************************************************************/
...
*
* Portuguese Keyboard has only three shifter keys:
...
//                      |=========|=========|
  ...
  {'K'          ,CAPLOK ,'k'      ,'K'      },
  {'L'          ,CAPLOK ,'l'      ,'L'      },
  {VK_OEM_3     ,CAPLOK ,0x00e7   ,0x00c7   },
  {VK_OEM_7     ,0      ,0x00ba   ,0x00aa   },
  {VK_OEM_5     ,0      ,'\\'     ,'|'      },
...
static VSC_LPWSTR aKeyNames[] = {
    ...
    0x37,    L"ASTERISCO (TN)",
    0x38,    L"ALT",
    0x39,    L"BARRA DE ESPA\x00C7" L"OS",
    0x3a,    L"CAPSLOCK",
    0x3b,    L"F1",
    0x3c,    L"F2",
    0x3d,    L"F3",
...
static VSC_LPWSTR aKeyNamesExt[] = {
    ...
    0x48,    L"SETA ACIMA",
    0x49,    L"PGUP",
    0x4b,    L"SETA \x00C0" L" ESQUERDA",
    0x4d,    L"SETA \x00C0" L" DIREITA",
    0x4f,    L"END",
    0x50,    L"SETA ABAIXO",
    0x51,    L"PGDOWN",
    0x52,    L"INSERT",
