...
*
* History:
* KBDTOOL v1.03 - Created  Tue Oct 08 22:12:10 2019
\***************************************************************************/
...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Swiss German
\***************************************************************************/
...
//                      |=========|=========|
  ...
  {'K'          ,CAPLOK ,'k'      ,'K'      },
  {'L'          ,CAPLOK ,'l'      ,'L'      },
  {VK_OEM_7     ,SGCAPS ,0x00f6   ,0x00e9   },
  {VK_OEM_7     ,0      ,0x00d6   ,0x00c9   },
  {VK_OEM_2     ,0      ,0x00a7   ,0x00b0   },
  {'Y'          ,CAPLOK ,'y'      ,'Y'      },
  {'X'          ,CAPLOK ,'x'      ,'X'      },
  {'C'          ,CAPLOK ,'c'      ,'C'      },
  {'V'          ,CAPLOK ,'v'      ,'V'      },
...
//                      |=========|=========|=========|
  ...
  {0xff         ,0      ,'^'      ,'`'      ,'~'      },
  {VK_OEM_5     ,SGCAPS ,0x00e4   ,0x00e0   ,'{'      },
  {VK_OEM_5     ,0      ,0x00c4   ,0x00c0   ,'{'      },
  {0            ,0      ,0        ,0        ,0        }
};
...
//                      |         |  Shift  |  Ctl+Alt|  Ctrl   |
//                      |=========|=========|=========|=========|
  {VK_OEM_1     ,SGCAPS ,0x00fc   ,0x00e8   ,'['      ,0x001b   },
  {VK_OEM_1     ,0      ,0x00dc   ,0x00c8   ,'['      ,0x001b   },
  {VK_OEM_3     ,0      ,WCH_DEAD ,'!'      ,']'      ,0x001d   },
  {0xff         ,0      ,'\"'     ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {VK_OEM_8     ,0      ,'$'      ,0x00a3   ,'}'      ,0x001c   },
