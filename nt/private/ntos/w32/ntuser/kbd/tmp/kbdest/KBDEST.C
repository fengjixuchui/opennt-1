/***************************************************************************\
* Module Name: KBDEST.C
*
* keyboard layout for Estonia
*
...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Estonia
\***************************************************************************/
...
*
* Estonia Keyboard has only three shifter keys:
...
//                      |=========|=========|
  {'1'          ,0      ,'1'      ,'!'      },
  {'5'          ,0      ,'5'      ,'%'      },
  {VK_OEM_PLUS  ,0      ,WCH_DEAD ,WCH_DEAD },
  {0xff         ,0      ,0x00b4   ,'`'      },
  {'Q'          ,CAPLOK ,'q'      ,'Q'      },
  {'W'          ,CAPLOK ,'w'      ,'W'      },
  {'E'          ,CAPLOK ,'e'      ,'E'      },
...
//                      |=========|=========|=========|=========|
  ...
  {'0'          ,0      ,'0'      ,'='      ,'}'      ,'}'      },
  {VK_OEM_MINUS ,0      ,'+'      ,'?'      ,'\\'     ,'\\'     },
  {VK_OEM_4     ,CAPLOK ,0x00f5   ,0x00d5   ,0x00a7   ,0x00a7   },
  {VK_OEM_5     ,0      ,'\''     ,'*'      ,0x00bd   ,0x00bd   },
  {0            ,0      ,0        ,0        ,0        ,0        }
};
...
//                      |=========|=========|=========|=========|=========|
  {VK_OEM_1     ,CAPLOK ,0x00f6   ,0x00d6   ,WCH_NONE ,WCH_NONE ,0x001b   },
  {VK_OEM_2     ,CAPLOK ,0x00e4   ,0x00c4   ,WCH_DEAD ,'^'      ,0x001d   },
  {0xff         ,0      ,WCH_NONE ,WCH_NONE ,'^'      ,WCH_NONE ,WCH_NONE },
  {VK_OEM_7     ,0      ,WCH_DEAD ,WCH_DEAD ,WCH_NONE ,WCH_NONE ,0x001c   },
  {0xff         ,0      ,0x02c7   ,'~'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {VK_OEM_6     ,0      ,'-'      ,'_'      ,WCH_NONE ,WCH_NONE ,0x001f   },
  {VK_OEM_102   ,0      ,'<'      ,'>'      ,'|'      ,'|'      ,0x001c   },
...
static DEADKEY aDeadKey[] = {
    DEADTRANS( L'a'   , L'`'   , 0x0101 ),
    DEADTRANS( L'o'   , L'`'   , 0x014d ),
    DEADTRANS( L'e'   , L'`'   , 0x0113 ),
    DEADTRANS( L'u'   , L'`'   , 0x016b ),
    DEADTRANS( L'A'   , L'`'   , 0x0100 ),
    DEADTRANS( L'O'   , L'`'   , 0x014c ),
    DEADTRANS( L'E'   , L'`'   , 0x0112 ),
    DEADTRANS( L'U'   , L'`'   , 0x016a ),
    DEADTRANS( L' '   , L'`'   , L'`'   ),
    ...
    DEADTRANS( L'i'   , L'^'   , 0x012f ),
    DEADTRANS( L'n'   , L'^'   , 0x0146 ),
    DEADTRANS( L'e'   , L'^'   , 0x0119 ),
    DEADTRANS( L'u'   , L'^'   , 0x0173 ),
    DEADTRANS( L'g'   , L'^'   , 0x0123 ),
    DEADTRANS( L'k'   , L'^'   , 0x0137 ),
    DEADTRANS( L'l'   , L'^'   , 0x013c ),
    DEADTRANS( L'A'   , L'^'   , 0x0104 ),
    DEADTRANS( L'I'   , L'^'   , 0x012e ),
    DEADTRANS( L'N'   , L'^'   , 0x0145 ),
    DEADTRANS( L'E'   , L'^'   , 0x0118 ),
    DEADTRANS( L'U'   , L'^'   , 0x0172 ),
    DEADTRANS( L'G'   , L'^'   , 0x0122 ),
    DEADTRANS( L'K'   , L'^'   , 0x0136 ),
    DEADTRANS( L'L'   , L'^'   , 0x013b ),
    DEADTRANS( L' '   , L'^'   , L'^'   ),
