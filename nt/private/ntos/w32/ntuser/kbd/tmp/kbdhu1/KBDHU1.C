/***************************************************************************\
* Module Name: KBDHU1.C
*
* keyboard layout for Hungarian 101-key
*
...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Hungarian 101-key
\***************************************************************************/
...
*
* Hungarian 101-key Keyboard has only three shifter keys:
...
//                      |=========|=========|
  ...
  {VK_OEM_PLUS  ,CAPLOK ,0x00f3   ,0x00d3   },
  {'R'          ,CAPLOK ,'r'      ,'R'      },
  {'T'          ,CAPLOK ,'t'      ,'T'      },
  {'Y'          ,CAPLOK ,'y'      ,'Y'      },
  {'U'          ,CAPLOK ,'u'      ,'U'      },
...
//                      |=========|=========|=========|
  ...
  {VK_OEM_PERIOD,0      ,'.'      ,':'      ,'>'      },
  {VK_OEM_2     ,0      ,'-'      ,';'      ,'_'      },
  {VK_OEM_102   ,CAPLOK ,0x00ed   ,0x00cd   ,'<'      },
  {0            ,0      ,0        ,0        ,0        }
};
...
//                      |=========|=========|=========|=========|
  ...
  {VK_OEM_5     ,CAPLOK ,0x0171   ,0x0170   ,'\\'     ,0x001c   },
...
//                      |=========|=========|=========|=========|=========|
  ...
  {VK_OEM_MINUS ,CAPLOK ,0x00fc   ,0x00dc   ,WCH_NONE ,WCH_NONE ,0x001f   },
  {0            ,0      ,0        ,0        ,0        ,0        ,0        }
};
...
/*** No dead key defined, dead key names ignored ! ***\
