...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Slovak
\***************************************************************************/
...
*
* Slovak Keyboard has only three shifter keys:
...
//                      |=========|=========|=========|=========|=========|
  ...
  {'G'          ,CAPLOK ,'g'      ,'G'      ,']'      ,0x0007   ,0x001d   },
  {'V'          ,CAPLOK ,'v'      ,'V'      ,'@'      ,0x0016   ,0x0000   },
