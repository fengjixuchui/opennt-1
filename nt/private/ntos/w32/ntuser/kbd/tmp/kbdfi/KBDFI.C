...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Finnish
\***************************************************************************/
...
static VSC_LPWSTR aKeyNamesExt[] = {
    ...
    0x54,    L"<00>",
    0x56,    L"HELP",
    0x5b,    L"Vasen Windows",
    0x5c,    L"Oikea Windows",
    0x5d,    L"Sovellus",
    0   ,    NULL
};

static LPWSTR aKeyNamesDead[] = {
    L"\x00b4"	L"AKUUTTIAKSENTTI",
    L"`"	L"GRAVISAKSENTTI",
    L"^"	L"SIRKUMFLEKSI",
    L"\x00a8"	L"TREEMA",
    L"~"	L"TILDE",
