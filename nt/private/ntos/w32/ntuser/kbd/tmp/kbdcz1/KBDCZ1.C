/***************************************************************************\
* Module Name: KBDCZ1.C
*
* keyboard layout for Czech_101
*
...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Czech_101
\***************************************************************************/
...
*
* Czech_101 Keyboard has only three shifter keys:
...
//                      |=========|=========|=========|=========|
  ...
  {0xff         ,0      ,0x00b4   ,0x02c7   ,WCH_NONE ,WCH_NONE },
  {VK_OEM_4     ,SGCAPS ,0x00fa   ,'/'      ,'['      ,'{'      },
  {VK_OEM_4     ,0      ,0x00da   ,'/'      ,'['      ,'{'      },
  {VK_OEM_7     ,0      ,0x00a7   ,'!'      ,'\''     ,'\"'     },
  {VK_OEM_3     ,0      ,';'      ,WCH_DEAD ,'`'      ,'~'      },
  {0xff         ,0      ,WCH_NONE ,0x00b0   ,WCH_NONE ,WCH_NONE },
  {VK_OEM_COMMA ,0      ,','      ,'?'      ,'<'      ,0x00d7   },
  {VK_OEM_PERIOD,0      ,'.'      ,':'      ,'>'      ,0x00f7   },
  {VK_OEM_2     ,0      ,'-'      ,'_'      ,'/'      ,'?'      },
  {VK_OEM_102   ,0      ,'\\'     ,'|'      ,0x00df   ,WCH_DEAD },
  {0xff         ,0      ,WCH_NONE ,WCH_NONE ,WCH_NONE ,0x02dd   },
  {0            ,0      ,0        ,0        ,0        ,0        }
};
...
//                      |=========|=========|=========|=========|=========|
  {'6'          ,SGCAPS ,0x017e   ,'6'      ,'^'      ,WCH_NONE ,0x001e   },
  {'6'          ,0      ,0x017d   ,'6'      ,'^'      ,WCH_NONE ,0x001e   },
  {VK_OEM_MINUS ,0      ,'='      ,'%'      ,'-'      ,'_'      ,0x001f   },
  {VK_OEM_6     ,0      ,')'      ,'('      ,']'      ,'}'      ,0x001b   },
  {VK_OEM_1     ,SGCAPS ,0x016f   ,'\"'     ,';'      ,':'      ,0x001d   },
  {VK_OEM_1     ,0      ,0x016e   ,'\"'     ,';'      ,':'      ,0x001d   },
  {VK_OEM_5     ,0      ,WCH_DEAD ,'\''     ,0x00a4   ,WCH_DEAD ,0x001c   },
