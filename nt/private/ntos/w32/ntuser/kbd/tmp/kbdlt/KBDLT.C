...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Lithuania
\***************************************************************************/
...
*
* Lithuania Keyboard has only three shifter keys:
...
//                      |=========|=========|
  ...
  {'0'          ,0      ,')'      ,'0'      },
  {VK_OEM_PLUS  ,0      ,'+'      ,'='      },
  {'Q'          ,CAPLOK ,0x0105   ,0x0104   },
  {'W'          ,CAPLOK ,0x017e   ,0x017d   },
  {'E'          ,CAPLOK ,'e'      ,'E'      },
  {'R'          ,CAPLOK ,'r'      ,'R'      },
  {'T'          ,CAPLOK ,'t'      ,'T'      },
  {'Y'          ,CAPLOK ,'y'      ,'Y'      },
  ...
  {'K'          ,CAPLOK ,'k'      ,'K'      },
  {'L'          ,CAPLOK ,'l'      ,'L'      },
  {VK_OEM_1     ,CAPLOK ,0x0173   ,0x0172   },
  {VK_OEM_7     ,CAPLOK ,0x0117   ,0x0116   },
  {VK_OEM_3     ,0      ,'`'      ,'~'      },
  {'Z'          ,CAPLOK ,'z'      ,'Z'      },
  {'X'          ,CAPLOK ,0x016b   ,0x016a   },
  {'C'          ,CAPLOK ,'c'      ,'C'      },
  {'V'          ,CAPLOK ,'v'      ,'V'      },
  {'B'          ,CAPLOK ,'b'      ,'B'      },
  {'N'          ,CAPLOK ,'n'      ,'N'      },
  {'M'          ,CAPLOK ,'m'      ,'M'      },
  {VK_OEM_COMMA ,CAPLOK ,0x010d   ,0x010c   },
  {VK_OEM_PERIOD,CAPLOK ,0x0161   ,0x0160   },
  {VK_OEM_2     ,CAPLOK ,0x0119   ,0x0118   },
  {VK_DECIMAL   ,0      ,','      ,0x0008   },
  {VK_TAB       ,0      ,'\t'     ,'\t'     },
  {VK_ADD       ,0      ,'+'      ,'+'      },
  {VK_DIVIDE    ,0      ,'/'      ,'/'      },
...
//                      |         |  Shift  |  Ctrl   |
//                      |=========|=========|=========|
  {VK_OEM_4     ,CAPLOK ,0x012f   ,0x012e   ,0x001b   },
  {VK_OEM_6     ,0      ,0x201c   ,0x201d   ,0x001d   },
  {VK_OEM_5     ,0      ,'|'      ,'\\'     ,0x001c   },
  {VK_OEM_102   ,0      ,'\\'     ,'|'      ,0x001c   },
