...
/***************************************************************************\
* ausVK[] - Virtual Scan Code to Virtual Key conversion table for Spanish
\***************************************************************************/
...
*
* Spanish Keyboard has only three shifter keys:
...
//                      |=========|=========|=========|=========|
  {'1'          ,0      ,'1'      ,'!'      ,WCH_NONE ,'|'      },
  {'2'          ,0      ,'2'      ,'\"'     ,WCH_NONE ,'@'      },
  {'3'          ,0      ,'3'      ,0x00b7   ,WCH_NONE ,'#'      },
  {VK_OEM_1     ,0      ,WCH_DEAD ,WCH_DEAD ,0x001b   ,'['      },
  {0xff         ,0      ,'`'      ,'^'      ,WCH_NONE ,WCH_NONE },
  {VK_OEM_PLUS  ,0      ,'+'      ,'*'      ,0x001d   ,']'      },
  {VK_OEM_7     ,0      ,WCH_DEAD ,WCH_DEAD ,WCH_NONE ,'{'      },
  {0xff         ,0      ,0x00b4   ,0x00a8   ,WCH_NONE ,WCH_NONE },
  {VK_OEM_5     ,0      ,0x00ba   ,0x00aa   ,WCH_NONE ,'\\'     },
  {VK_OEM_2     ,CAPLOK ,0x00e7   ,0x00c7   ,0x001c   ,'}'      },
  {0            ,0      ,0        ,0        ,0        ,0        }
};
