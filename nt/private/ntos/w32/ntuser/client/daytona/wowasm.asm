...
EXTRN	@HMValidateHandle@8:NEAR
;	COMDAT @ValidateHwnd@4
_TEXT	SEGMENT
; File ..\wow.c
@ValidateHwnd@4 PROC NEAR				; COMDAT
; Line 157
...
EXTRN	@HMValidateHandleNoRip@8:NEAR
;	COMDAT @ValidateHwndNoRip@4
_TEXT	SEGMENT
@ValidateHwndNoRip@4 PROC NEAR				; COMDAT
; Line 176
	mov	eax, DWORD PTR fs:24
	add	eax, 68					; 00000044H
; Line 181
...
_pwnd$ = 8
_id$ = 12
__GetDlgItem@8 PROC NEAR				; COMDAT
; Line 254
	push	ebp
...
; Line 413
	test	eax, eax
	je	SHORT $L23629
	test	DWORD PTR _uFlags$[ebp], -65536		; ffff0000H
	jne	SHORT $L23629
; Line 417
	push	DWORD PTR _uFlags$[ebp]
...
EXTRN	__IsWindowVisible@4:NEAR
;	COMDAT _IsWindowVisible@4
_TEXT	SEGMENT
_hwnd$ = 8
...
; Line 760
	...
	jl	SHORT $L23915
	mov	ecx, 32767				; 00007fffH
	mov	edx, DWORD PTR _lpPoint$[ebp]
	cmp	eax, ecx
	jl	SHORT $L23919
	mov	eax, ecx
$L23919:
...
$L23733:
	push	0
	mov	ecx, DWORD PTR _uEnable$[ebp]
...
; Line 831
	mov	ecx, eax
	xor	ecx, DWORD PTR _uEnable$[ebp]
	test	cl, 3
	jne	SHORT $L23735
; Line 832
	and	eax, 3
