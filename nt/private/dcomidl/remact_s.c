...
extern RPC_DISPATCH_TABLE IActivation_DispatchTable;
...
RPC_IF_HANDLE _IActivation_ServerIfHandle = (RPC_IF_HANDLE)& IActivation___RpcServerInterface;
...
static const MIDL_STUB_DESC IActivation_StubDesc = 
    {
    (void __RPC_FAR *)& IActivation___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static RPC_DISPATCH_FUNCTION IActivation_table[] =
    {
    NdrServerCall2,
    0
    };
RPC_DISPATCH_TABLE IActivation_DispatchTable = 
    {
    1,
    IActivation_table
    };
...
static const SERVER_ROUTINE IActivation_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)_RemoteActivation
    };
