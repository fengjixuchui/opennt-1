...
static const RPC_CLIENT_INTERFACE IRundown___RpcClientInterface =
    {
...
RPC_IF_HANDLE IRundown_ClientIfHandle = (RPC_IF_HANDLE)& IRundown___RpcClientInterface;

extern const MIDL_STUB_DESC IRundown_StubDesc;

static RPC_BINDING_HANDLE IRundown__MIDL_AutoBindHandle;
    ...
    /* [size_is][out] */ unsigned char __RPC_FAR afOkToRundown[  ])
{
...
#if defined( _ALPHA_ )
    va_start(vlist,afOkToRundown);
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IRundown_StubDesc,
    ...
    _RetVal = NdrClientCall2(
                  ...
                  ( unsigned char __RPC_FAR * )&cOid,
                  ( unsigned char __RPC_FAR * )&aOid,
                  ( unsigned char __RPC_FAR * )&afOkToRundown);
#else
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IRundown_StubDesc,
                  (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[0],
...
static const COMM_FAULT_OFFSETS IRundown_CommFaultOffsets[] = 
{
	{ -2, -2 },
	{ -2, -2 },
	{ -2, -2 },
	...
	{ -2, -2 },
#ifdef _X86_
	{ -1, -1 } 	/* x86 Offsets for RawRundownOid */
#endif
#if defined(_MIPS_) || defined(_PPC_)
	{ -1, -1 } 	/* MIPS, PPC Offsets for RawRundownOid */
#endif
#ifdef _ALPHA_
	{ -1, -1 } 	/* Alpha Offsets for RawRundownOid */
#endif
};
...
static const MIDL_STUB_DESC IRundown_StubDesc = 
    {
    (void __RPC_FAR *)& IRundown___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &IRundown__MIDL_AutoBindHandle,
    0,
    0,
    ExprEvalRoutines,
    0,
