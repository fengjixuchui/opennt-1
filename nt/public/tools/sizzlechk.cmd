:START
	...
	if "%PROCESSOR_ARCHITECTURE%" == "ALPHA" set USERNAME=alphachk
	if "%PROCESSOR_ARCHITECTURE%" == "MIPS"  set USERNAME=mipschk
	if "%PROCESSOR_ARCHITECTURE%" == "PPC"   set USERNAME=ppcchk
	if "%PROCESSOR_ARCHITECTURE%" == "x86"   set USERNAME=x86chk
